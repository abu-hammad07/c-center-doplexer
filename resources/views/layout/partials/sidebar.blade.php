                    ...
                    <ul>
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                class="{{ Request::is('channels', 'numbers-list', 'numbers', 'tools-compliance', 'my-request') ? 'active subdrop' : '' }}">
                                <i data-feather="grid"></i><span>Channels & Numbers</span><span
                                    class="menu-arrow"></span></a>
                            <ul>
                                <li>
                                    <a href="{{ url('channels') }}" class="{{ Request::is('channels') ? 'active' : '' }}">
                                        Channels
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="{{ url('my-requests') }}"
                                        class="{{ Request::is('my-requests') ? 'active' : '' }}">
                                        My Requests
                                    </a>
                                </li>
                            </ul>
