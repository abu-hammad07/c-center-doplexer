...
$(document).ready(function(){
	...
	$(document).on('click', '#all_filter_search', function() {
		$('#all_filter_inputs').slideToggle("slow");
	});
	$(document).on('click', '#dlc_vln_filter_search', function() {
		$('#dlc_vln_filter_inputs').slideToggle("slow");
	});
